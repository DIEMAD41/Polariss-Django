"""
Django settings for Polariss project.
...
SECRET_KEY = 'django-insecure-r2*m#z6k%41_vf-j#m)bl)=t@xvro*6q-sxwc2bdd6#)s-27%q'
...
WSGI_APPLICATION = 'Polariss.wsgi.application'
